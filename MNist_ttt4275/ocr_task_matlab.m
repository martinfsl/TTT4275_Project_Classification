...
% [w_1, c_1, cm_1, wd_1, wl_1, cd_1, cl_1, tp_lab_1] = deal(0, 0, zeros(10, 10), zeros(1, vec_size), zeros(1, 2), zeros(1, vec_size), zeros(1, 2), zeros(10000, 2));
% 
% % Same as the above, only that they are used in the 7NN-classification
% [w_1_7, c_1_7, cm_1_7, wd_1_7, wl_1_7, cd_1_7, cl_1_7, tp_lab_1_7] = deal(0, 0, zeros(10, 10), zeros(1, vec_size), zeros(1, 2), zeros(1, vec_size), zeros(1, 2), zeros(10000, 2));
% 
...
%     disp("Classifying");
%     % 1-NN classifier:
%     [cm_1, wd_1, wl_1, w_1, cd_1, cl_1, c_1, tp_lab_1] = classify_1NN(distances_set, number_of_tests, testing_data, testing_labels, trainlab, cm_1, wd_1, wl_1, w_1, cd_1, cl_1, c_1, tp_lab_1);
%     % 7-NN classifier:
...
%     
%     % 1-NN classifier
%     [cm_2, wd_2, wl_2, w_2, cd_2, cl_2, c_2, tp_lab_2] = classify_1NN(distances_clustering, number_of_tests, testing_data, testing_labels, training_labels, cm_2, wd_2, wl_2, w_2, cd_2, cl_2, c_2, tp_lab_2);
%     % 7-NN classifier
...
% cm_plot = confusionchart(true_pred_lab_2(:, 1), true_pred_lab_2(:, 2));
plot_confusion_matrix(tp_lab_2, "");
pause(10);
plot_confusion_matrix(tp_lab_2_7, "");
...
function plot_confusion_matrix(true_pred_labels, title)
